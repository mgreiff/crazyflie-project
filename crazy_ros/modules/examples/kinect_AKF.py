...
# Prediction in the AKF uses a reference trjectory in acceleration, which can be 
# modified such that the true acceleration of the copter is a factor 0.8, 1 or 1.2
# from the true acceleration, to show that the method is robust to non-perfect
