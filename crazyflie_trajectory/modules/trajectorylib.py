...
class Trajectory(object):
    ...
    def __init__(self, directory, filename, fileformat):
        ...
        self.nDim = 4                   # The number of flat output dimensions
    ...
    def packet(self):
        ...
        trajectoryData = {'packets':packets, 'settings':settings}
    ...
    def save(self, filename):
        ...
        trajectoryData = self.packet()

        path = os.path.join(self.directory, filename)
        with open(path, 'w') as outfile:
            json.dump(trajectoryData, outfile , separators=(',', ':'), sort_keys=True, indent=4)
