...
if __name__ == "__main__":
    ...
    for ii in range(numberOfTimesteps):
        ...
        ukm1 = generate_omega_sequence(t)
    ...
    if 1: # States
        ...
        axarr[0,0].set_ylabel('$\mathbf{p}(t)$')
        axarr[0,0].legend(['x','y','z'],loc=3,fontsize=6)
        axarr[0,0].set_title('$\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad$ True states')
        
        axarr[0,1].step(np.transpose(timevec),np.transpose(states[3:6,:]))
        axarr[0,1].set_xlabel('Time, [s]')
        axarr[0,1].set_ylabel('$\dot{\mathbf{p}}(t)$')
    ...
    if 1: # estimates
        ...
        axarr[0,0].set_ylabel('$\mathbf{p}(t)$')
        axarr[0,0].legend(['x','y','z'],loc=3,fontsize=6)
        axarr[0,0].set_title('$\qquad\qquad\qquad\qquad\qquad\qquad\qquad$ Estimated states')
