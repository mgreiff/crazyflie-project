...
class TiLQRcontroller(Controller):
    ...
    def compute_control(self):
        ...
        xtilde = ref - self.xhat
        utilde = np.array([[m*g],[0.],[0.],[0.]])
        udelta = -np.dot(self.K, xtilde)          # Thust in [N], angles in [rad]
        u = utilde + udelta                       # Thust in [N], angles in [rad]
        u[1:4] *= (180/pi)                        # Thust in [N], angles in [degrees]
