...
std_Q = 0;   % Standard deviation on process noise (no noise added)
std_R = 0.1; % Standard deviation of measurement noise
KFparam.Q = (std_Q^2)*eye(nStates);
KFparam.R = (std_R^2)*eye(nMeasuredStates);
